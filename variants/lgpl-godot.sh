...
H264="--enable-decoder=mpeg4,h264,aac,aac_latm,mp3 --enable-demuxer=mov,aac,flv,avi,mpegts,mpegtsraw --enable-parser=h264,mpeg4video,mpegaudio,mpegvideo,aac,aac_latm"
